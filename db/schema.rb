...
ActiveRecord::Schema[7.1].define(version: 2025_07_04_095357) do
  ...
  create_table "device_assignments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["device_id", "active"], name: "index_device_assignments_on_device_id_and_active", unique: true, where: "active = true"
